        ...
        <div className="row justify-content-between g-4 align-items-center">
          <div className="col-lg-8">
            <div>
              ...
              <p className="section-desc">The Interactive 3D iFluent Unit, available in both home and commercial versions, offers varying scales of immersive educational experiences tailored to different environments. Here&rsquo;s a brief overview of the two models</p>
            </div>
          </div>
        </div>
